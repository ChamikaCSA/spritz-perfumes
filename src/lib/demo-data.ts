...
const brands: Record<string, Brand> = {
  ...
  creed: {
    ...
    name: "Creed",
    slug: "creed",
    description: "Heritage house of niche fragrances",
...
export const DEMO_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    projection: "Strong",
    season: "Year-round",
    occasion: "Signature · Evening · Special occasion",
  ...
  },
  {
    ...
    projection: "Moderate",
    season: "Fall · Winter",
    occasion: "Evening · Intimate · Formal",
  ...
  },
  {
    ...
    gender: "unisex",
    longevity: "12+ hours",
    projection: "Strong · Beast mode",
    season: "Year-round",
    occasion: "Evening · Special occasion · Signature",
    country_of_origin: "France",
    year_released: 2015,

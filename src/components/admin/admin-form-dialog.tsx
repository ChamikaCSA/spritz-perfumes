...
export function AdminFormDialog({
  ...
  triggerVariant?: "ghost" | "amber" | "link";
  size?: "md" | "lg" | "xl";
  className?: string;
}) {
  return (
        ...
        render={
          <button
            ...
            className={cn(
              ...
              triggerVariant === "link" &&
                "inline-flex min-h-11 items-center px-2 text-xs uppercase tracking-[0.14em] text-muted-foreground transition hover:text-amber",
              className,
            )}
          />
        }

  ...
  return (
    <footer className="mt-auto border-t border-border/60">
        ...
        <div className="grid gap-8 sm:gap-12 md:grid-cols-2 lg:grid-cols-4 lg:gap-8">
          <div className="md:col-span-2 lg:col-span-2">
            ...
            <a
              ...
              className="mt-5 inline-flex text-sm text-amber transition hover:text-amber-soft"
            >
      ...
      <div className="border-t border-border/40">
        <div className="mx-auto max-w-6xl px-4 py-5 text-xs text-muted-foreground/70 sm:px-6 lg:px-8">

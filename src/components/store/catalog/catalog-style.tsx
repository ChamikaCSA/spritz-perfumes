...
import { BrandCard } from "@/components/store/catalog/brand-card";
...
import type { Brand, Product, VariantType } from "@/types";
  ...
  useEffect(() => {
    try {
      ...
      if (stored !== initialStyle) {
        ...
        // eslint-disable-next-line react-hooks/set-state-in-effect -- client-only style restore
